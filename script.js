...
function sendChat() {
    ...
    setTimeout(() => {
        ...
        if (lower.includes('cat rambut') || lower.includes('warna rambut')) {
        ...
        } else if (lower.includes('hairstyle') || lower.includes('gaya rambut')) {
            ...
            appendMessage('bot', 'Coba fitur AI kami: Virtual Try-On, Cat Rambut, Makeup, atau Analisis Kulit! ✨');
        }
    }, 800);
}
