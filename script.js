// ============================================================
// LuxArc AI — script.js v2025050102
// FIX: Endpoint API diganti dari Netlify ke Vercel (/api/get-youcam-key)
//      formatRupiah didefinisikan PERTAMA agar tidak undefined
...
// --- YouCam API Service (Key dari Vercel, bukan hardcode) ---
class YouCamService {
    constructor() {
        this.apiKey    = null;
        this.apiSecret = null;
    ...
    async init() {
        try {
            // ✅ FIX UTAMA: Ganti endpoint Netlify → Vercel
