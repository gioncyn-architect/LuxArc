...
// ════════════════════════════════════════════════════════════
// ── AI ADVISOR — Chat & Quick Replies (Powered by Gemini) ───
// ════════════════════════════════════════════════════════════
const chatHistory = document.getElementById('chat-history');

// Simpan riwayat chat untuk konteks Gemini
...
async function sendToGemini(userMessage) {
    try {
        const res = await fetch('/api/gemini', {
            ...
            body: JSON.stringify({
                message: userMessage,
                history: geminiChatHistory.slice(-10), // kirim 10 pesan terakhir sebagai konteks
            }),
        });
        const data = await res.json();
...
async function sendChat() {
    ...
    // ── Semua pertanyaan lain → Gemini AI ────────────────────
    ...
    geminiChatHistory.push({ role: 'bot', text: reply });
